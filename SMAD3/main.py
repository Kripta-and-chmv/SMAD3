...
check_2 = f.check_regres_importance_of_the_model(est_tetta, Y, np.float32(matr_X), N)
#intervals_for_E = f.calculate_freq_intervals_for_Expected_value(N, est_tetta, est_sigma_2, x1, XtX_1, 1)
print(check_1)
#f.Graph(x1, y_x1_0)
#f.Graph(x2, y_0_x2)